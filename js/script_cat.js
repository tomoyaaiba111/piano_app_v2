...
function onKeyDown(keyboard){
    ...
    if(hz == undefined)
        return;
    keyboard.style.backgroundColor = 'rgb(214, 244, 17)'; // 押下された鍵盤の色を変える
...
async function playTime(name, beat){
    ...
    if(name != ""){
        ...
        if(elm != null)
            elm.style.backgroundColor = 'rgb(240, 170, 6)'; // 鳴っている音に対応する鍵盤の色を変える
        const hz = hzs[name];
        if(hz != undefined)
            playFromHz(hz);
    }
...
const data = [
    'd4', 0.5,'c4', 0.5,'f3', 1,'f4', 1,'f4', 1, 
    'd4', 0.5,'c4', 0.5,'f3', 1,'f4', 1,'f4', 1,
    'd4', 0.5,'c4', 0.5,'f3', 1,'f4', 1,'d3', 1, 'f4', 1,'c3', 1,'e4', 1,'e4',1,
    'd4', 0.5,'c4', 0.5,'c3', 1,'e4', 1,'e4', 1,
    'd4', 0.5,'c4', 0.5,'c3', 1,'e4', 1,'e4', 1,
    'd4', 0.5,'c4', 0.5,'c3', 1,'e4', 1,'d3', 1, 'e4', 1,'f3', 1,'f4', 1,'f4',1,'',1,
    'f4', 1,'c4', 0.5,'c4', 0.5,'c4#', 1,'c4', 1, '', 1,'e4', 1,'f4', 1,'',
];
