...
function onKeyDown(keyboard){
    ...
    if(hz == undefined)
        return;
    keyboard.style.backgroundColor = 'rgb(100, 212, 222)'; // 押下された鍵盤の色を変える
...
async function playTime(name, beat){
    ...
    if(name != ""){
        ...
        if(elm != null)
            elm.style.backgroundColor = 'rgb(100, 222, 200)'; // 鳴っている音に対応する鍵盤の色を変える
        const hz = hzs[name];
        if(hz != undefined)
            playFromHz(hz);
    }
...
const data = [
    'g5#', 1,'d5#', 1,'c5#', 1,'g4#', 1,'d5#', 1.5,'c5#', 1.5,'f5', 0.25,'f5#', 0.125,'g5#', 0.375,'d5#', 1.5,'c5#', 2,'c5', 1.5,'a4#', 2,
    'b5#', 1,'d5#', 1,'c5#', 1,'g4#', 1,

    'd5#', 1.5,'c5#', 1.5,'f5', 0.25,'f5#', 0.125,'g5#', 0.375,'d5#', 1.5,'c5', 2,'a4#', 3,'g5#', 0.25,'g5#', 0.125,'b5#', 0.375,

    'f4', 0.25,'f4', 0.125,'f4', 0.25,'f4', 0.125,'f4', 0.375,'f4', 0.25,'f4', 0.125,'f4', 0.25,'f4#', 0.25,'b4#', 0.25,'g4#', 0.25,'b4#', 0.5,

    'a4#', 0.25,'b4#', 0.25,'a4#', 0.25,'a4#', 0.125,'a4#', 0.325,'a4#', 0.25,'a4#', 0.125,'a4#', 0.25,'c5', 0.25,'b5#', 0.25,'c5#', 0.25,'b5#', 1,

    'f4#', 0.5,'d5#', 0.5,'c5#', 0.5,'c5#', 0.5,'c5', 1,'a4#', 0.5,'g4#', 0.75,'f4#', 0.25,'f4', 2,'b4#', 1,

    'f4', 0.25,'b4#', 0.125,'f4', 0.25,'f4', 0.125,'f4', 0.375,'f4', 0.25,'f4', 0.25,'b4#', 0.125,'f4#', 0.25,'b4#', 0.25,'g4#', 0.25,'b4#', 0.5,

    'a4#', 0.5,'a4#', 0.5,'a4#', 0.5,'a4#', 0.25,'a4#', 0.5,'c5', 0.5,'c5#', 0.25,

    'b4#', 0.5,'b4#', 0.5,'f4#', 0.5,'d5#', 0.5,'c5#', 0.5,'c5#', 0.5,'c5', 0.5,'c5', 0.5,'c5', 0.5,'c5', 0.75,'c5#', 0.125,'c5#', 2,

    'b5#', 1,'c5#', 0.5,'c5#', 0.5,'c5#', 0.5,'c5#', 0.25,'d5#', 0.75,'d5#', 0.5,'d5#', 0.5,'f5', 0.5,'f5', 0.5,'a4#', 0.5,'a4#', 0.5,'g4#', 0.25,'g4#', 1.5,

    'b4#', 0.5,'c5#', 0.5,'c5#', 0.5,'c5#', 0.5,'c5#', 0.25,'d5#', 0.375,'d5#', 0.5,'d5#', 0.5,'f5', 0.5,'f5', 3,'f5#', 0.25,'f5', 0.25,'d5#', 2,'g5#', 0.25,'g5#', 0.25,

    //サビ
    'f5', 0.25,'f5#', 0.25,'g5#', 0.5,'d5#', 0.75,'f5', 0.25,'d5#', 0.5,'c5#', 1,'c5#', 0.5,'b5#', 0.5,'c5#', 0.5,'g4#', 0.5,'g4#', 0.25,'c5', 0.5,'c5', 0.25,'c5#', 1,'b5#', 0.5,

    'f5', 0.25,'f5#', 0.25,'g5#', 0.5,'d5#', 0.75,'f5', 0.25,'d5#', 0.5,'c5#', 0.5,

    'b5#', 0.5,'c6#', 1.25,'c6#', 0.25,'c6#', 0.1875,'c6', 0.25,'a5#', 0.5,'a5', 0.5,'a5', 0.25,'a5#', 1.25,

    'b5#', 0.5,'f5', 0.25,'f5#', 0.25,'g5#', 0.5,'d5#', 0.75,'f5', 0.25,'d5#', 0.5,'c5#', 0.75,'c5#', 0.25,'c5#', 0.5,'b5#', 0.5,
    
    //
    'c5#', 0.5,'g4#', 0.5,'g4#', 0.25,'c5', 0.5,'c5', 0.25,'c5#', 0.5,'b5#', 0.5,'c5#', 0.5,'d5#', 0.5,'f5', 0.5,'f5#', 0.5,'f5', 0.5,'d5#', 0.5,'c5#', 1,'c5', 1,'c5#', 0.25,'c5', 0.25,'a4#', 2, 'b4#', 1,

    'g5#', 1,'d5#', 1,'c5#', 1,'g4#', 1,'d5#', 1.5,'c5#', 1.5,'f5', 0.25,'f5#', 0.125,'g5#', 0.375,'d5#', 1.5,'c5#', 2,'c5', 1.5,'a4#', 2,
    'b5#', 1,'d5#', 1,'c5#', 1,'g4#', 1,

    'd5#', 1.5,'c5#', 1.5,'f5', 0.25,'f5#', 0.125,'g5#', 0.375,'d5#', 1.5,'c5#', 2,'c5', 3,
];
